...
CONSTRAINT fk_Class FOREIGN KEY (SubID) REFERENCES [Subject](SubID),
CONSTRAINT fk_Class1 FOREIGN KEY (LID) REFERENCES Lecturer(LID),
CONSTRAINT fk_class2 FOREIGN KEY (SemID) REFERENCES Semester(SemID),
);
...
CONSTRAINT fk_Group2 FOREIGN KEY (SubID) REFERENCES [Subject](SubID),
CONSTRAINT fk_Group3 FOREIGN KEY (SemID) REFERENCES Semester(SemID),
CONSTRAINT fk_group4 FOREIGN KEY (ClassID) REFERENCES Class(ClassID),
);

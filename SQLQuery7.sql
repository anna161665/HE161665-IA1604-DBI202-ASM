...
GO
DELETE [dbo].[Assesment] ([AssID], [Type], [Part], [Weight], [Completion Criteria], [Duration], [Knowledge and Skill], [NOTE]) VALUES (N'ASM', N'On-going', 1, 0.2, N'>0', N'at home', N'sinple RDBS', NULL)
GO
DELETE [dbo].[Assesment] ([AssID], [Type], [Part], [Weight], [Completion Criteria], [Duration], [Knowledge and Skill], [NOTE]) VALUES (N'FE', N'final exam', 1, 0.3, N'>5', N'60''', N'all', NULL)
GO
DELETE [dbo].[Assesment] ([AssID], [Type], [Part], [Weight], [Completion Criteria], [Duration], [Knowledge and Skill], [NOTE]) VALUES (N'Labs', N'On-going', 5, 0.15, N'>0', N'in lab session', N'related to student modules ', NULL)
GO
